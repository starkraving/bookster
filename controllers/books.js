...
router.get('/search/isbn/:isbn', function(req, res){
	res.render("books_search_isbn_isbn", {title: " search isbn :isbn"});
});
...
router.get('/search/state/:state', function(req, res){
	res.render("books_search_state_state", {title: " search state :state"});
});
...
router.get('/search/user/:user', function(req, res){
	res.render("books_search_user_user", {title: " search user :user"});
});
