...
module.exports = (function(){
	...
	var objReturn = {
		...
		getByEmails: function(req, res, next) {
			memberModel.find({email: {$in: res.owners}}).exec(function(err, results){
		...
		validateInfo: function(memberInfo, postData, requireEmail, requirePassword) {
	...
	objReturn.getByEmail = function(scope) {
		return function(req, res, next) {
			objReturn.findOne({email: req[scope].email}, function(result){
				res.member = result;
				next();
			});
		}
